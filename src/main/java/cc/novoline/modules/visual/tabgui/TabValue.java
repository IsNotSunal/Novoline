...
public final class TabValue {
    ...
    public void render() {
        ...
        double i1 = Minecraft.getInstance().getDebugFPS() / 13;
        ...
        switch (this.setting.getSetting().getSettingType()) {
            case SLIDER: {
                ...
                if (rounded % 1 == 0) {
                    string = new DecimalFormat("0.##").format(rounded);
                } else {
                    string = rounded + "";
                }
                ...
                SF_18.drawString(string, 114 + this.setting.getModule().getLongest() + this.setting.getLongestS(),
                        y + 3, 0xffffffff, true);
                break;
            }
            case COMBOBOX: {
    ...
    public int getLong() {
        ...
        switch (this.setting.getSetting().getSettingType()) {
            case SLIDER: {
                ...
                return SF_18.stringWidth(string);
            }
            case COMBOBOX: {

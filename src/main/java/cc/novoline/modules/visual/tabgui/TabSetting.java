...
public final class TabSetting {
    ...
    public void render() {
        ...
        double v = Minecraft.getInstance().getDebugFPS() / 13;
        ...
        if (isSelected())
            Gui.drawRect(89 + this.module.getLongest(), y, 108 + this.module.getLongest() + getLongestS(), eY, module.getType().getTabGUI().getColor());

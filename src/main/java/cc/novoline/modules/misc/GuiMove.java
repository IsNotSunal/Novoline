...
public final class GuiMove extends AbstractModule {
    ...
    public void updatePlayerMoveState() {
        ...
        if (Keyboard.isKeyDown(mc.gameSettings.keyBindForward.getKeyCode())) {
            movementInput.setMoveForward(movementInput.moveForward() + 1);
        }
        ...
        if (Keyboard.isKeyDown(mc.gameSettings.keyBindLeft.getKeyCode())) {
            movementInput.setMoveStrafe(movementInput.moveStrafe() + 1);
        }
        ...
        if (movementInput.sneak() && !isEnabled(FastSneak.class)) {
            movementInput.setMoveStrafe(movementInput.moveStrafe() * 0.3F);
            movementInput.setMoveForward(movementInput.moveForward() * 0.3F);
        }
    }
}

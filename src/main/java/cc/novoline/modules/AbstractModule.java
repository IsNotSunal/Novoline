...
public abstract class AbstractModule {
    ...
    protected void checkModule(@NotNull Class<? extends AbstractModule> @NotNull ... modules) {
        for (Class<? extends AbstractModule> mClass : modules) {
            ...
            if (module.isEnabled()) {
                module.toggle();
                novoline.getNotificationManager().pop(this.getDisplayName(), module.name + " was disabled to prevent flags/errors", 1_000, WARNING);
            }
        }
    }
    ...
    public void print(Object... debug) {
        if (Integer.parseInt(Protection.serviceUid) < 5 && isEnabled(Debug.class)) {
